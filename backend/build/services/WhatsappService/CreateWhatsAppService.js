...
const CreateWhatsAppService = ({ name, status = "OPENING", queueIds = [], greetingMessage, farewellMessage, isDefault = false, companyId }) => __awaiter(void 0, void 0, void 0, function* () {
