...
const CheckContactNumber = (number, companyId) => __awaiter(void 0, void 0, void 0, function* () {
    logger_1.logger.info('Cheking contact number ' + number + ' in business: ' + companyId);
