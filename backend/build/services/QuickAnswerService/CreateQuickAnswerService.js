...
const CreateQuickAnswerService = ({ shortcut, message }, companyId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const quickAnswer = yield QuickAnswer_1.default.create({ shortcut, message, companyId });
    return quickAnswer;
});
