...
const ListUsersService = ({ searchParam = "", pageNumber = "1", companyId = -1 }) => __awaiter(void 0, void 0, void 0, function* () {
    let whereCondition = {};
    if (companyId > 0) {
        whereCondition = {
            [sequelize_1.Op.or]: [
    ...
    const { count, rows: users } = yield User_1.default.findAndCountAll({
        ...
        include: [
            { model: Queue_1.default, as: "queues", attributes: ["id", "name", "color", "startWork", "endWork"] },
            { model: Whatsapp_1.default, as: "whatsapp", attributes: ["id", "name"] },
            { model: Company_1.default, as: "company", attributes: ["name"] },
        ]
    });
