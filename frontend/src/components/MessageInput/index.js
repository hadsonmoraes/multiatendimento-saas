...
const MessageInput = ({ ticketStatus }) => {
  ...
  if (medias.length > 0)
    return (
      <Paper elevation={0} square className={classes.viewMediaInputWrapper} onDragEnter={() => setOnDragEnter(true)}
    ...
    return (
      ...
      <Paper
        ...
        onDrop={(e) => handleInputDrop(e)}
      >
        <div className={onDragEnter ? classes.dropInfo : classes.dropInfoOut} style={{fontWeight: "bold",}}>
